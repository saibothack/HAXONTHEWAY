...
namespace HaxOnTheWay.Droid
{
    ...
    [IntentFilter(new string[] { "com.xamarin.HaxOnTheWay.Droid.LocationUpdatesService" })]
	public class LocationUpdatesService : Service
	{
        const string LocationPackageName = "com.xamarin.HaxOnTheWay.Droid";
